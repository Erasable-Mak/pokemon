    ...
    if(Details)
    {
        return (
            ...
            <div className={isopen?"flex h-screen bg-blue-300 rounded-l-xl md:top-0 right-0 fixed md:w-2/5 w-full flex-wrap":"hidden"}>
                ...
                <div className="flex items-center bg-red-700 md:m-5 mx-5 mt-2 rounded-xl w-full justify-between">
                    <div>
              ...
              {/*  <div className=" w-full h-60 lg:h-96 rounded-xl w-full md:w-2/5 mx-5 mt-2 bg-purple-700 flex flex-col justify-center items-center">
                    <p className="font-bold text-black text-2xl ">Moves</p>
                ...
                <div className=" w-full h-60 lg:h-96 rounded-xl w-full md:w-2/5 mx-5 mt-2 bg-purple-700 flex flex-col justify-center items-center">
                    <p className="font-bold text-black text-3xl ">Stats</p>
                    <div className="overflow-y-auto flex flex-col justify-center items-center my-2">
